...
def home(request):
    ...
    total_cases = words[total_cases]

    # ------this is for total_recovered

    total_recovered = words.index('total_recovered') + 1
    total_recovered = words[total_recovered]

    # ------this is for the total_deaths

    total_deaths = words.index('total_deaths') + 1
    total_deaths= words[total_deaths]


    return render(request,'home.html',{'total_cases':total_cases,'total_recovered':total_recovered,
...
def chart(request):
  ...
  "chart": {
    "caption": "World corona virus cases",
